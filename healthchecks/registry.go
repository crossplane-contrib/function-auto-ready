...
func init() {
	...
	registerEndpointsHealthCheck()
	registerEventHealthCheck()
	registerHorizontalPodAutoscalerHealthCheck()
	registerIngressHealthCheck()
	registerJobHealthCheck()
	registerLimitRangeHealthCheck()
	registerNamespaceHealthCheck()
	registerNodeHealthCheck()
	registerPersistentVolumeClaimHealthCheck()
	registerPersistentVolumeHealthCheck()
	registerPodHealthCheck()
	registerReplicaSetHealthCheck()
	registerReplicationControllerHealthCheck()
	registerResourceQuotaHealthCheck()
